...
const sendEmail = async (to: string, id: string, code: string) => {
  try {
    await transporter.sendMail({
      ...
      to: to,
      subject: 'Reset password request | QuizyMe',
      html: `
      <html lang="en">
				<head>
					<meta charset="UTF-8">
				...
				<body>
					...
					<h1 style="width: fit-content; margin-top: 15px; margin-bottom: 15px;">
            You have requested to reset your password on QuizyMe!
						...
						<p class="ignore" style="margin-top: 25px; margin-bottom: 15px;">
							If you didn't request a password reset, you can ignore this email or contact us at: support@codebybartlomiej.pl
						</p>
