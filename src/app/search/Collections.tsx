  ...
  return (
    <>
      ...
      </Link>
      {
        selected 
        ? 
          <button className='bg-black ml-auto flex rounded-full text-white px-6 py-2 mt-3 font-bold border-b-4 border-r-4 box-border border-red hover:border-black duration-300' onClick={handleDeleteParams}>
            Reset category
          </button>
        : 
          null
