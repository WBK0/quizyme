  ...
  return (
    <div className="flex flex-col">
      <div className="w-full flex justify-between px-3 sm:px-6 py-2 flex-wrap sm:flex-nowrap">
        <div className="sm:flex-1 flex items-center gap-2 sm:gap-3 order-1">
        ...
        <div className="sm:flex-2 flex justify-center items-center order-last sm:order-2 w-full mt-2 sm:mt-0">
          <p className="font-black text-lg">{actualCard + 1} / {flashcards.length}</p>
        </div>
        <div className="sm:flex-1 flex justify-end order-3">
